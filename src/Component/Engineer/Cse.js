...
function Cse() {
 ...
 <div class="container">
   ...
   <center> <h2 class="text-white  display-3 nursingsmt  "  > Diploma In Computer Science & Engineering</h2></center>
...
<h1 className='library-heading'>	Course <span className='library-span'>Overview</span></h1>
            ...
            <p className='nursing-p'>
            The candidate must have passed 10th examination or equivalent with 40% marks or equivalent Grade Point Average (GPA) from a recognized board.</p>
            <h3 className='library-heading'>Duration & Eligibility (Lateral Entry) </h3>
            <p className='nursing-p'>
            2 Years (4 Semesters). 10+2 or equivalent with PCM OR ITI Diploma (2 Years) with 40% marks or equivalent Grade Point Average (GPA) from a recognized board.</p>
